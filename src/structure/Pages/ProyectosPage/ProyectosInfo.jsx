      ...
      >
        <div className="space-container flex horizontal-col-2 gap-2em">
          <div className="flex column-direction gap-10px">
            <label className="text-principal-bold text-red sombra text-size-2">
              Conoce el Proyecto
            </label>
            <label className="text-principal-bold text-white sombra text-size-2">
            ...
            {Info.fotos.map((element, index) => {
              return (
                <a
                  ...
                  onClick={() => {
                    setImagen(element.img), setModalIsOpen(true);
                  }}
                >
                  <div className="titulo">
                    <label className="text-secundario-bold text-size-3 text-white">
                      {element.titulo}
                    </label>
                  </div>
                  <div className="foto">
            ...
            {Info.beneficios.map((element, index) => {
              return (
                <div key={index} className="text-center">
                  <i
                    className={
                      "fa-solid text-red text-size-1 sombra " + element.icon
                    }
                  ></i>
                  <div>
                    <p className="text-secundario-bold text-black sombra">
                      {element.titulo}
                    </p>
                  </div>
                </div>
        ...
        <div className="space-container">
          ...
          <div className="flex horizontal-col-2 gap-1em">
            {mapa == 1 ? (
              ...
              <button
                className="btn white text-secundario-bold text-red text-size-3 padding-10px sombra"
                onClick={() => setMapa(1)}
              >
                Referencia
              </button>
          ...
          {mapa == 1 ? (
            <img src={Info.page.mapa_foto} className="sombra" />
          ) : (
            <iframe
